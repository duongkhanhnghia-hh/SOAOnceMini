 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://webservice.pnq.com/", wsdlLocation = "http://localhost:8888/books?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://webservice.pnq.com/", "WebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/books?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://webservice.pnq.com/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.pnq.com/", "WebServicePort"), WebService.class, features);
    }
