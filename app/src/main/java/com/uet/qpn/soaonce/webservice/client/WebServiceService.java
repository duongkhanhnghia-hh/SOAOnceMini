 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://webservice.pnq.com/", wsdlLocation = "http://localhost:8000/books/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8000/books/?wsdl");
